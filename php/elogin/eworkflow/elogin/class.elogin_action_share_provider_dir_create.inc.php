 ...
 */
class elogin_action_share_provider_dir_create extends elogin_action_share_provider_shares_base implements IEntry, IParam {
	...
	public function execute($params) {
		...
		$dirname = EworkflowVfs::cleanUtf8PathName($dirname);
