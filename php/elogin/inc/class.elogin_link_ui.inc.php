<?php
	...
	class elogin_link_ui {
        ...
        public function link_list($content=null) {
            ...
            if( !is_array($content) ) {
                if( !($content['nm'] = egw_session::appsession('elogin_link_list', 'elogin')) ) {
            ...
            $tpl = new etemplate_new('elogin.link_list');
			$tpl->exec(
        ...
        public function get_rows_link(&$query, &$rows, &$readonlys) {
			egw_session::appsession('elogin_link_list', 'elogin', $query);
		...
		public function edit($content=array()) {
			...
			$etemplate = new etemplate_new('elogin.link.dialog');
            $etemplate->exec(
