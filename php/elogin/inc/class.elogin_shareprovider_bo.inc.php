...
class elogin_shareprovider_bo {
	...
	public function __construct($id=null) {
		...
		if( $data ) {
			...
			$this->_autoadd_users_group		= json_decode($data['el_autoadd_users_group'], true);
	 ...
	 * @return array
	 */
	public function getAutoAddUserGroup() {
		return $this->_autoadd_users_group;
	}
	 ...
	 * @param array $groups
	 */
	public function setAutoAddUserGroup($groups) {
		$this->_autoadd_users_group = $groups;
	}
	...
	public function save() {
		...
		$data['el_collectiv_user_share']	= $this->_collectiv_user_share;
