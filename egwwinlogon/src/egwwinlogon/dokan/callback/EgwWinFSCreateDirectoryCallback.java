...
import egwwinlogon.dokan.lib.DokanOperations.CreateDirectoryCallback;

/**
 * EgwWinFSCreateDirectoryCallback
 * @author Stefan Werfling
 */
public class EgwWinFSCreateDirectoryCallback implements CreateDirectoryCallback, IEgwWinFSVolumeCallback {
	...
	public int invoke(WString path, DokanFileInfo dokanFileInfo) {
		if( this._volume != null ) {
			return this._volume.onCreateDirectory(path, dokanFileInfo);
		}
