...
import egwwinlogon.dokan.lib.DokanOperations.CloseFileCallback;

/**
 * EgwWinFSCloseFileCallback
 * @author Stefan Werfling
 */
public class EgwWinFSCloseFileCallback implements CloseFileCallback, IEgwWinFSVolumeCallback {
	...
	public int invoke(WString path, DokanFileInfo dokanFileInfo) {
		if( this._volume != null ) {
			return this._volume.onCloseFile(path, dokanFileInfo);
		}
