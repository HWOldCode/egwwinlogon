...
import egwwinlogon.dokan.lib.DokanOperations.DeleteFileCallback;

/**
 * EgwWinFSDeleteFileCallback
 * @author Stefan Werfling
 */
public class EgwWinFSDeleteFileCallback implements DeleteFileCallback, IEgwWinFSVolumeCallback {
	...
	public int invoke(WString path, DokanFileInfo dokanFileInfo) {
		if( this._volume != null ) {
			return this._volume.onDeleteFile(path, dokanFileInfo);
		}
