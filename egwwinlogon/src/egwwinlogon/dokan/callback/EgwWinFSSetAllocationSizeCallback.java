...
import egwwinlogon.dokan.lib.DokanOperations.SetAllocationSizeCallback;

/**
 * EgwWinFSSetAllocationSizeCallback
 * @author Stefan Werfling
 */
public class EgwWinFSSetAllocationSizeCallback implements SetAllocationSizeCallback, IEgwWinFSVolumeCallback {
	...
	public int invoke(WString path, long length, DokanFileInfo dokanFileInfo) {
		if( this._volume != null ) {
			return this._volume.onSetAllocationSize(path, length, dokanFileInfo);
		}
